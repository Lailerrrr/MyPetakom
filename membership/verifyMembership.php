...
// Fetch only pending membership applications with student info
$query = "
    SELECT 
        m.membershipID, 
        m.studentID, 
    ...
    <aside class="sidebar">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="verifyMembership.php" class="active">Verify Membership</a></li>
    ...
    <main class="main-content">
        ...
        <section class="application-list">
            <?php if ($result && $result->num_rows > 0): ?>
                    ...
                    <div class="application-card">
                        ...
                        <div class="application-details">
                            ...
                            <p><strong>Status:</strong> 
                                <span class="status-pending"><?= htmlspecialchars($row['status']) ?></span>
                            </p>

                            <form method="post" action="processMembership.php" class="action-buttons">
                                <input type="hidden" name="membershipID" value="<?= htmlspecialchars($row['membershipID']) ?>">
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p class="no-applications">No pending membership applications found.</p>
            <?php endif; ?>
        </section>
    </main>
</body>
