                        ...
                        <?php while ($row = $events->fetch_assoc()): ?>
                            <tr>
                                <form method="POST">
                                    ...
                                    <td><input type="text" name="eventName" value="<?php echo $row['eventName']; ?>" required></td>
                                    <td><input type="date" name="eventDate" value="<?php echo $row['eventDate']; ?>" required></td>
                                    <td><input type="text" name="venue" value="<?php echo $row['venue']; ?>" required></td>
                                    <td>
                                    ...
                                    <td>
                                        <?php if (!empty($row['approvalLetter'])): ?>
                                            <a href="<?php echo $row['approvalLetter']; ?>" class="btn-view" target="_blank">View</a>
                                        <?php else: ?>
                                            N/A
                                        <?php endif; ?>
                                    </td>
